...
This step requires perl with Text::Glob and a few other core modules, not-forkong installation will inform you if the relevant modules are missing on your system, more information on installing it on different systems can be found below, as well as with the [not-forking documentation](https://lumosql.org/src/not-forking/doc/trunk/README.md).
